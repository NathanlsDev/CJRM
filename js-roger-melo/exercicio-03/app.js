...
*/
dogNames.push('Nina')
const initals = `${dogNames[0].slice(0,1)}${dogNames[1].slice(0,1)}${dogNames[2].slice(0,1)}${dogNames[3].slice(0,1)}`
// console.log(initals)
...
*/
// console.log(initals.toLocaleLowerCase())
