...
const orderedCharacters = getArrayCopy(characters)
  .sort((idValue1, idValue2) => idValue1.id - idValue2.id);
...
const orderedNumbers = getArrayCopy(numbers)
...
const orderedPeople = getArrayCopy(people)
  .sort()
  .reverse();
...
const ingredientsMessage = ingredients.reduce(
