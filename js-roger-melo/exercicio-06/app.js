...
const isMorning = currentHour >= 0 && currentHour <= 11;
...
if (isMorning) {
  ...
  console.log(`Boa noite agora são ${currentHour} horas`);
}
...
console.log(
  `O crazyArray tem ${typeBoolean} booleans, ${typeNumber} números e ${typeString} strings.`
);
